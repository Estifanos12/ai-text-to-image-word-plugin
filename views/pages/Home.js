const Home = {
  ...
  render: async () => {
    ...
    <div class="w-full flex flex-col items-center gap-2">
      <img src="./assets/logo/logo.png" alt="Logo" class="w-24 aspect-video" />
      <div class="space-y-2 flex flex-col items-center">
        ...
        <a href="" class="text-sm underline text-blue-600 visited:text-purple-600">Learn more</a>
      </div>
    </div>
    <div class="w-full pb-5 pt-10">
      <div class="w-full text-right mb-2">
          <a href="/taskpane.html/#/history" class="text-sm underline text-blue-600 visited:text-purple-600 place-self-end">Previously generated images</a>
      </div>
      <form class="w-full flex flex-row outline outline-gray-300 rounded-2xl">
        ...
        />
        <button type="submit"  class="w-[15%] disabled:cursor-not-allowed disabled:opacity-50 bg-white flex items-center justify-center rounded-r-2xl">
